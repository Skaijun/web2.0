...
function () {
  function Basket() {
    ...
    this.totalPrice = JSON.parse(window.localStorage.getItem("totalprice")) || 0; // this.addProductToCart = this.addProductToCart.bind(this);
  ...
  _createClass(Basket, [{
    ...
    value: function getStateOfMiniBasket(className) {
      ...
      for (var article in myCart) {
        ...
        output += "<li><div class=\"".concat(className, "__wrap\">\n                                  <div class=\"").concat(className, "__img\">\n                                      <img\n                                       class=\"details-page\"\n                                       data-art=\"").concat(itemKey, "\"\n                                       src=\"").concat(_goods_goods_js__WEBPACK_IMPORTED_MODULE_0__["goods"][itemKey].image, "\"\n                                       alt=\"").concat(_goods_goods_js__WEBPACK_IMPORTED_MODULE_0__["goods"][itemKey].description, "\"\n                                       title=\"").concat(_goods_goods_js__WEBPACK_IMPORTED_MODULE_0__["goods"][itemKey].name, "\"\n                                       width=\"100px\" height=\"100px\"\n                                       />\n                                      <button class=\"remove-from-basket\" data-art=\"").concat(article, "\"> - </button>\n                                      <span>").concat(myCart[article], " it.</span>\n                                      <button class=\"add-to-basket\" data-art=\"").concat(article, "\"> + </button>\n                                  </div>\n                                  <div class=\"").concat(className, "__details\">\n                                     <button class=\"delete-product\" data-art=\"").concat(article, "\">&times;</button>\n                                     <div class=\"").concat(className, "__name\">").concat(_goods_goods_js__WEBPACK_IMPORTED_MODULE_0__["goods"][itemKey].name, "</div>\n                                     <div class=\"").concat(className, "__features\">\n                                        <div class=\"").concat(className, "__size\">size: ").concat(itemSize, "</div>\n                                        <div class=\"").concat(className, "__color\">color: ").concat(itemColor, "</div>\n                                     </div>\n                                     <div class=\"").concat(className, "__price\">$ ").concat(_goods_goods_js__WEBPACK_IMPORTED_MODULE_0__["goods"][itemKey].price, "</div>\n                                  </div>\n                               </div>\n                           </li>");
      }
    ...
    key: "setEventsToElements",
    value: function setEventsToElements() {
    ...
    key: "minusItemFromTheBasket",
    value: function minusItemFromTheBasket() {
...
var goodsState = {
  ...
  renderFeatGoodsMainPage: function renderFeatGoodsMainPage() {
    Object(_utils_goods_render_js__WEBPACK_IMPORTED_MODULE_0__["renderFeaturedGoods"])(this.goodsFeaturedMainPage.category, this.goodsFeaturedMainPage.condition, this.goodsFeaturedMainPage.howManyGoodsDepictInOneRow);
  },
  renderShoesCategoryShoesPage: function renderShoesCategoryShoesPage() {
    Object(_utils_goods_render_js__WEBPACK_IMPORTED_MODULE_0__["renderFeaturedGoods"])(this.goodsCategoryShoesPage.category, this.goodsCategoryShoesPage.condition, this.goodsCategoryShoesPage.howManyGoodsDepictInOneRow);
  }
};
